...
class AudioProcessor:
    def __init__(self, device=1, channels=(6, 7), samplerate=48000,
        ...
        self.channel_names = {ch: f'ch{ch}' for ch in self.channels}
        # initialize per-channel entries
        self._ensure_state(noise_init_db)
        self.stream = None
        self.running = False
    # Star generation defaults are set from constructor args
    ...
    def _cb(self, indata, frames, time_info, status):
        ...
        for ch in self.channels:
            ...
            with self._lock:
                ...
                # mark audio activity if above small margin over estimated floor
                try:
